...
#print filter_words(['how', 'about', 'i', 'go', 'through', 'that', 'little', 'passage', 'to', 'the', 'south'], skip_words)
...
def normalise_input(user_input):
    ...
    full_list = no_punct.split()
    ok_input = filter_words(full_list, skip_words)
    return ok_input
