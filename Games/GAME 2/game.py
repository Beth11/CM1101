...
def list_of_items(items):
    ...
    item_string = ""
    for keys in items:
        item_list.append(keys["name"])
    for item in item_list:
        item_string = item_string + str(item) + ", "
    return item_string[0:-2]
...
def execute_go(direction):
    ...
    if is_valid_exit(current_room["exits"], direction) == True:
        ...
        print( "You go to " + str(current_room ["name"]))
    else:
...
def main():
    ...
    # Main game loop
    while True:
        if items['biscuits'] in rooms["Parking"]["items"]:
            print('The man sees you with the biscuits- stumbles over and takes them from your hand.')
            print ("He hands you five £20 notes.")
            print ("")
            print ("That sounds like a VICTORY to me- thanks for playing!")
            break
